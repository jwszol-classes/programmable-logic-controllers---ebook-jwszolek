...
<h3>Relay:</h3>
  <b>As with any typical relay, the PLC output module had physical coils and relay contacts contained inside.
The contacts were operated by applying a voltage to the relay coil. The contacts were connected to an external supply to turn on or off a discrete device.<b/>
  <h3>Solid-State:</h3>
...
<h4>- Transistor<h4/>
  <b>The transistor output module is voltage-dependent and can only operate on DC loads</b>
  <h4>- Triac</h4>
  <b>A Triac output module is capable of controlling AC loads</b>
