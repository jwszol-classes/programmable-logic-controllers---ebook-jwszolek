...
**Bit Operation Functions:** AND, OR, XOR, NOT, SHL, SHR, ROL, ROR, BIT_SET, BIT_CLR, BIT_TEST, BIT_POS, MSKCMP.
...
**Data operation functions in LD:** MOVE, BLKCLR, BLKMOV, SHFR, BITSEQ, COMMREQ
