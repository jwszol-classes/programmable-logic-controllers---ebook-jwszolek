...
**1. Provides a Logix based real-time controller that runs an instance of Windows 10 IoT Enterprise:**

**2. Supported in Studio 5000 Logix Designer® version 32:**

**3. Is ideal for mid-size to large applications requiring high performance control and data throughput:**

**4. Enables high-speed I/O, motion control, and Device Level Ring/Linear topologies:**

**5. Includes three GbE Ethernet/IP ports that enable high-speed communications, I/O, and motion control (two are configurable, and support Dual IP address or Device Level Ring):**

**6. Includes one GbE Ethernet port as a dedicated commercial OS network interface:**

**7. Supports up to 31 local Bulletin 5069 Compact I/O™ modules:**

**8. Offers enhanced security features that include digitally-signed controller firmware, controller-based change detection, and a log of role-based access control to routines and Add-On instructions:**

**9. Allows users to deploy Windows 10 based off the shelf and/or custom applications while tightly integrated with real time Logix control:**

**10. Includes integrated DisplayPort for high definition industrial monitor connectivity:**

**11. Includes two USB 3.0 ports for OS peripheral and expanded data storage capability:**
