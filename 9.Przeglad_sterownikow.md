...
GE Intelligent Platforms PACSystems RX3i controllers are solutions designed for the automation of medium and large-scale control systems. These systems not only handle a large number of I/O signals but also demand extensive functionality, rich communication capabilities, and high reliability.
