...
Dodatkowym utrudnieniem będzie brak normy, która odpowiadałaby za ustandaryzowanie, gdzie znajdują się poszczególne lokalizacje pamięci, w których będziemy zapisywać dane. Mapy pamięci różnią się nie tylko wśród różnych producentów, ale również wewnątrz pojedynczych urządzen danego producenta. 
