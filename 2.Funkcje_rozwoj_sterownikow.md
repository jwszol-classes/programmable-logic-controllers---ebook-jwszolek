...
- małe projekty mogą być kosztowney.
...
- https://automatykaonline.pl/Artykuly/Sterowanie/Sterowniki-programowalne
- https://sterowniki-plc.net/plc-czym-sa-sterowniki-programowalne
- https://www.ecstuff4u.com/2019/04/advantages-disadvantages-PLC.html?m=1&fbclid=IwAR2B0W7Fe8AhJkZ_5w2EYA_qZaALmDa5QXpS4rs-ul1a6M0_8VXwOCWvURc
...
### Output modules
Similar to inputs, they are divided according to the type of data that can be obtained from them - digital and analog. They are used to control auto ambient actuators, e.g. contacts, regulators, solenoid valves, control systems.
...
The power supplies used in the controllers are often dedicated to the designed structures, which makes them quite expensive.
...
### Phases of the controlers work cycle

##### 1. Control Initilization
##### 2. Input Data Reading
##### 3. Execution of Contorlers Task
##### 4. Output Data Writing
##### 5. Comunications Handling
##### 6. Autodiagnositics
